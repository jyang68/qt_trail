...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/jian/qt_trail/src/qtros)
  set(qtros_DEVEL_PREFIX /home/jian/qt_trail/devel)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /home/jian/qt_trail/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Jian <Jian@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jian/qt_trail/src/qtros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jian/qt_trail/devel/lib;/home/jian/qt_trail/devel/lib;/opt/ros/kinetic/lib)
